...
# Get the set of labels (failure mode codes)
def get_fmcodes():
...
# Return a dictionary of few-shot examples for each label
def get_fewshot_examples():
    """ Returns a dictionary of few-shot examples for each label. """
